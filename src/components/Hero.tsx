...
export const Hero = () => {
  ...
  return (
    ...
    tab:pt-[56px] tab:pb-[162px] tab:clip-path-down-cut-tab "
    >
      ...
      <div className="px-4 tab:px-5 pc:px-[60px] max-w-[540px] tab:max-w-full pc:max-w-[1440px] mx-auto">
        <div className="tab:flex tab:justify-between">
          <h1 className="uppercase font-exo font-semibold text-3xl tab:text-4xl text-title mb-4 tab:mb-0">
            {t.rich("title", {
              br: () => <br />,
            })}
          </h1>
          <div className="hidden tab:block relative w-[211px] h-[89px] tab:mt-4 tab:mr-2 pc:mr-0">
            <Image
              ...
              height={89}
            />
            <div className="absolute top-0 left-0 w-full h-full pt-4 pl-[30px] uppercase z-[-1]">
        ...
        <div className="w-full tab:w-[70%] h-auto mb-8 tab:mb-[83px] mx-auto">
          <Image
            src="/images/dron.png"
            alt="fpv"
            width={757}
        ...
        <div className="flex flex-col tab:flex-row gap-10 justify-center tab:justify-between mx-auto max-w-[330px] tab:max-w-full">
          <ul className="flex flex-col gap-3 font-exo text-title tab:w-[288px] ">
          ...
          <div className="mx-auto w-[288px] ml-auto mr-0">
